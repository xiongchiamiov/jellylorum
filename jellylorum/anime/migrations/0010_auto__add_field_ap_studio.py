...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AP.studio'
        db.add_column('anime_ap', 'studio', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AP.studio'
        db.delete_column('anime_ap', 'studio')
