...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ANN.themes'
        db.add_column('anime_ann', 'themes', self.gf('django.db.models.fields.CharField')(default=None, max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ANN.themes'
        db.delete_column('anime_ann', 'themes')
