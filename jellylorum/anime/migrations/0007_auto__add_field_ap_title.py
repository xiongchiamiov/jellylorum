...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AP.title'
        db.add_column('anime_ap', 'title', self.gf('django.db.models.fields.CharField')(default='Kimi ni Todoke', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AP.title'
        db.delete_column('anime_ap', 'title')
