...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AniDB.title'
        db.add_column('anime_anidb', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AniDB.title'
        db.delete_column('anime_anidb', 'title')
