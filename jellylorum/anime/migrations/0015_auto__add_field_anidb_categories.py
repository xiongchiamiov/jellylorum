...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AniDB.categories'
        db.add_column('anime_anidb', 'categories', self.gf('django.db.models.fields.CharField')(default=None, max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AniDB.categories'
        db.delete_column('anime_anidb', 'categories')
