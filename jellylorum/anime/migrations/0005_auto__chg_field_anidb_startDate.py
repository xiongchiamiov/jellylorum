...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AniDB.startDate'
        db.alter_column('anime_anidb', 'startDate', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'AniDB.startDate'
        db.alter_column('anime_anidb', 'startDate', self.gf('django.db.models.fields.DateField')(default=None))
