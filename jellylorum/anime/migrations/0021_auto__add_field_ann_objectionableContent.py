...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ANN.objectionableContent'
        db.add_column('anime_ann', 'objectionableContent', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ANN.objectionableContent'
        db.delete_column('anime_ann', 'objectionableContent')
