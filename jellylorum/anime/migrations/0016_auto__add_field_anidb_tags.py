...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AniDB.tags'
        db.add_column('anime_anidb', 'tags', self.gf('django.db.models.fields.CharField')(default=None, max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AniDB.tags'
        db.delete_column('anime_anidb', 'tags')
