...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AP.rating'
        db.add_column('anime_ap', 'rating', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=4, decimal_places=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AP.rating'
        db.delete_column('anime_ap', 'rating')
