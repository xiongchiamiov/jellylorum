...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AP.tags'
        db.add_column('anime_ap', 'tags', self.gf('django.db.models.fields.CharField')(default=None, max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AP.tags'
        db.delete_column('anime_ap', 'tags')
