...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AniDB.rawAverageRating'
        db.add_column('anime_anidb', 'rawAverageRating', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=4, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'AniDB.weightedAverageRating'
        db.add_column('anime_anidb', 'weightedAverageRating', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=4, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AniDB.permanentRating'
        db.add_column('anime_anidb', 'permanentRating', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=4, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'AniDB.temporaryRating'
        db.add_column('anime_anidb', 'temporaryRating', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=4, decimal_places=2, blank=True), keep_default=False)

        # Deleting field 'AniDB.rawAverageRating'
        db.delete_column('anime_anidb', 'rawAverageRating')

        # Deleting field 'AniDB.weightedAverageRating'
        db.delete_column('anime_anidb', 'weightedAverageRating')
