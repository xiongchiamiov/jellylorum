...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ANN.endDate'
        db.add_column('anime_ann', 'endDate', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ANN.endDate'
        db.delete_column('anime_ann', 'endDate')
